...
<html>
  <head>
    <meta charset="utf-8">
    <title>Homeschooling 101</title>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('files/css/beranda.css') ?>">
    ...
    <div class="container">
      <navbar>
        <ul>
          ...
          <li style="float:right"><a class="logout" href="<?php echo base_url('index.php/berandamurid/aksi_logout') ?>">Logout</a></li>
        </ul>
      </navbar>
      <berita>
        <h3>JUDUL</h3>
